...
<p align="center">
  ...
  <a href="https://github.com/mpdigitals/pdf-builder-sfdc/releases"><img src="https://img.shields.io/badge/pre--release-v1.0.16--beta.2-orange" alt="Current pre-release"></a>
</p>
...
Install the current beta unlocked package (`v1.0.16-beta.2`). It is an
...
| ----------------- | ----------------------------------------------------------------------------------------------------------------- |
| Sandbox           | [Install in a sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tQy000000ZFgvIAG)          |
| Developer Edition | [Install in Developer Edition](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tQy000000ZFgvIAG) |
